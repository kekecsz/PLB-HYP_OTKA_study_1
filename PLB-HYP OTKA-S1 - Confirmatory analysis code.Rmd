...
The example data can be created by using a data simulating code. Link:https://github.com/kekecsz/PLB-HYP_OTKA_study_1/blob/main/Data%20simulation%20for%20confirmatory%20analysis.R
